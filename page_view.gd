...
const PANEL_STYLE = preload("res://stylebox_postcard.tres")
const FONT_TITLE = preload("res://font/Vegur-Bold.otf")
const FONT_TITLE_SIZE = 32
const FONT_BODY = preload("res://font/Vegur-Regular.otf")
const FONT_BODY_SIZE = 16
const FONT_META = preload("res://font/Vegur-Regular.otf")
